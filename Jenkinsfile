...
node {
	...
	sh '''
		...
		ssh root@192.168.0.1 "docker rmi $imageid;cd /home/item;tar zxvf myhelloworld.tar.gz;docker build -t 118.178.135.157:5000/item/myhelloworld:$tag .;docker login --username pftz --password Pftz8888 118.178.135.157:5000;docker push 118.178.135.157:5000/item/myhelloworld:$tag;rm -rf *"
